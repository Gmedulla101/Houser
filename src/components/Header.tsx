...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full flex flex-col gap-2 text-center justify-between py-4 px-10 items-center transition-all duration-500 ease-in-out bg-white mx-auto overflow-hidden z-50 xmd:flex-row shadow-md`} style={{maxHeight: isOpen ? "300px" : "65px"}}
    >
