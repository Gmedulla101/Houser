...
const DisplayCards = ({
  ...
  return (
    <div className="card flex flex-col justify-between shadow-3xl border-2 border-gray-300 shadow-xl rounded-lg p-2 w-[350px] h-[500px]">
      <img src={imgUrl} alt={`${title}`} className="h-[250px] rounded-lg" />
